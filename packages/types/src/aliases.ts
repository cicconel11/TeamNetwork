// Compatibility aliases over the generated Supabase types.
// Kept in a separate file so regenerating database.ts does not wipe them.
...
// Convenience string-literal types
