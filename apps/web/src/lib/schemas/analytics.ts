...
export const analyticsEventSchema = z.discriminatedUnion("event_name", [
  ...
  z.object({ event_name: z.literal("support_flow_start"), payload: donationFlowPayloadSchema }),
  z.object({ event_name: z.literal("support_checkout_start"), payload: donationCheckoutStartPayloadSchema }),
  z.object({ event_name: z.literal("support_checkout_result"), payload: donationCheckoutResultPayloadSchema }),
