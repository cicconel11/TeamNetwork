...
const FORCED_SINGLE_CASES: RoutingCase[] = [
  ...
  {
    name: "job detail: 'delete this' → prepare_delete_job_posting",
    message: "delete this",
    surface: "general",
    intentType: "action_request",
    currentPath: "/team/jobs/3fa85f64-5717-4562-b3fc-2c963f66afa6",
    expectIncludes: [],
    expectForcedSingle: "prepare_delete_job_posting",
  },
  {
    name: "job detail: 'close this' → prepare_update_job_posting",
    message: "close this",
    surface: "general",
    intentType: "action_request",
    currentPath: "/team/jobs/3fa85f64-5717-4562-b3fc-2c963f66afa6",
    expectIncludes: [],
    expectForcedSingle: "prepare_update_job_posting",
  },
  {
    name: "event detail: 'delete this' → prepare_delete_event",
    message: "delete this",
    surface: "events",
    intentType: "action_request",
    currentPath: "/team/calendar/events/3fa85f64-5717-4562-b3fc-2c963f66afa6",
    expectIncludes: [],
    expectForcedSingle: "prepare_delete_event",
  },
  {
    name: "event detail: 'move this' → prepare_update_event",
    message: "move this",
    surface: "events",
    intentType: "action_request",
    currentPath: "/team/calendar/events/3fa85f64-5717-4562-b3fc-2c963f66afa6",
    expectIncludes: [],
    expectForcedSingle: "prepare_update_event",
  },
  {
    name: "general surface: bare 'delete this' does not overmatch entity deletion",
    message: "delete this",
    surface: "general",
    intentType: "action_request",
    expectIncludes: ["list_members"],
    expectExcludes: ["prepare_delete_event", "prepare_delete_job_posting"],
  },
  {
    name: "general surface: member role change beats job update words",
    message: "change Riley to admin",
    surface: "general",
    intentType: "action_request",
    expectIncludes: [],
    expectForcedSingle: "prepare_member_role_change",
  },
  {
