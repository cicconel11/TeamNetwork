...
export default function EditAlumniScreen() {
  ...
  const fetchAlumni = useCallback(async () => {
    ...
    try {
      ...
      setFetchError((e as Error).message || "Failed to load alumni data.");
    } finally {
      setIsFetching(false);
    }
  }, [orgId, alumniId]);
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      router.push(`/(app)/${orgSlug}/alumni/${alumniId}`);
    } catch (e) {
      setError((e as Error).message || "Failed to update alumni.");
    } finally {
      setIsSaving(false);
    }
  }, [orgId, orgSlug, alumniId, formData, validateForm, router]);
          ...
          <SafeAreaView edges={["top"]} style={styles.headerSafeArea}>
            <View style={styles.headerContent}>
              ...
              <View style={styles.headerTextContainer}>
                <Text style={styles.headerTitle}>Edit Alumni</Text>
              </View>
            </View>
          </SafeAreaView>
        </LinearGradient>
      ...
      <View style={styles.container}>
        ...
        <View style={[styles.contentSheet, styles.centered]}>
          ...
          <Text style={styles.accessDeniedText}>
            Only administrators can edit alumni.
          </Text>
          <Pressable
      ...
      >
        ...
        >
          <View style={styles.formHeader}>
            <Text style={styles.formTitle}>Edit Alumni</Text>
            <Text style={styles.formSubtitle}>Update alumni information</Text>
          </View>
