...
export function DrawerContent(props: DrawerContentComponentProps) {
  ...
  const items = useMemo<NavItem[]>(() => {
    ...
    const all: NavItem[] = [
      ...
      { label: "Connections", href: `/(app)/${slug}/connections`, icon: Network, configKey: "/connections" },
      ...
      { label: "Team Funding", href: `/(app)/${slug}/philanthropy`, icon: Heart, configKey: "/philanthropy" },
      { label: "Contributions", href: `/(app)/${slug}/donations`, icon: DollarSign, configKey: "/donations" },
