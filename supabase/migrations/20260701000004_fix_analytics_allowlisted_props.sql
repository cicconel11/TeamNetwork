-- Restore allowlisted analytics props that were blocked by broad key-name filters.
-- Keep the per-event allowlist and value-shape validation as the privacy boundary.
