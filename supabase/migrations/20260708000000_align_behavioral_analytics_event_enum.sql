-- Align the behavioral analytics enum with the live app contract.
-- Removes deprecated/unwired events from both the enum and RPC allowlist.

ALTER TYPE public.analytics_event_name RENAME TO analytics_event_name_old;
...
USING event_name::text::public.analytics_event_name;

DROP FUNCTION IF EXISTS public.log_analytics_event(
  UUID,
  UUID,
  DATE,
  TEXT,
  ...
  TEXT,
  TEXT,
  public.analytics_event_name_old,
  JSONB
);
...
DROP TYPE public.analytics_event_name_old;
