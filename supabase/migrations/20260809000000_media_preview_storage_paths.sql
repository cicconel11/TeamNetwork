...
COMMENT ON COLUMN public.media_uploads.preview_storage_path IS
  'Optional storage path for a browse-sized preview asset. Originals remain at storage_path.';

ALTER TABLE public.media_items
  ADD COLUMN IF NOT EXISTS preview_storage_path text;

COMMENT ON COLUMN public.media_items.preview_storage_path IS
  'Optional storage path for a browse-sized preview asset. Originals remain at storage_path.';
