...
describe("Email signup callback URLs", () => {
  it("marks email signup confirmations as signup mode", () => {
    const url = buildEmailSignupCallbackUrl(siteUrl, "/app/join?token=abc123");
    const parsed = new URL(url);
