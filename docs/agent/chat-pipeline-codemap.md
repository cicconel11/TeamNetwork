...
| `src/lib/ai/context-builder.ts` | Prompt context assembly — surface-gated queries, bounded route-entity context, token budget, ContextMetadata | `buildPromptContext`, `buildSystemPrompt`, `buildUntrustedOrgContextMessage`, `ContextMetadata` |
