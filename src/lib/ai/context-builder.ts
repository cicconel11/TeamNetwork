...
export async function buildPromptContext(
  ...
  const systemPrompt = [
    ...
    "Use tools when the user asks about specific members, events, statistics, announcements, discussions, or job postings.",
    "Recent announcement titles are shown in the context above — call list_announcements when the user asks for announcement details, body content, or a full list.",
    "Call list_discussions when the user asks about discussion threads, community conversations, or forum activity.",
    "Call list_job_postings when the user asks about jobs, openings, or hiring. Active postings are shown by default.",
    "You cannot create, edit, or delete announcements, discussions, or job postings. If the user asks you to, say so clearly and suggest they use the relevant section of the platform.",
